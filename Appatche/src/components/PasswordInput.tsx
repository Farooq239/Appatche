            ...
            <View style={[styles.input, inputStyle, isActive && styles.activeInput]}>
                ...
                {passwordSecure && (
                    <TouchableOpacity onPress={onSetIsSecure}  >
                        ...
                        {isSecure && isSecure ? <Image style={{ height: 22, width: 22, tintColor: ColorSet.darkGrey, resizeMode: 'contain' }} source={Icons.ic_eyeDisable} /> : <Image style={{
                            height: 22, width: 22,
                            alignItems: 'center',
                            tintColor: ColorSet.darkGrey,
                            resizeMode: 'contain'
                        }} source={Icons.ic_eye} />}
                        {/* </Text> */}
                    </TouchableOpacity>
